...
function Print-EffectiveRuntimeConfiguration {
    ...
    foreach ($name in @("TRANSCRIPTION_ENGINE", "WHISPER_MODEL_SIZE", "WHISPER_DEVICE", "WHISPER_COMPUTE_TYPE", "WHISPER_LANGUAGE", "WHISPER_MODEL_CACHE_DIR", "DIARIZATION_ENABLED")) {
