...
class Settings(BaseSettings):
    ...
    meeting_deep_think_max_sections: int = Field(default=10, alias="MEETING_DEEP_THINK_MAX_SECTIONS")
    meeting_deep_think_excerpt_chars_per_section: int = Field(default=3000, alias="MEETING_DEEP_THINK_EXCERPT_CHARS_PER_SECTION")
